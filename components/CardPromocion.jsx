...
const CardPromocion = ({ promocion, producto }) => {
    ...
    const [fechaInicio, setFechaInicio] = useState(promocion.desde);
    const [fechaFin, setFechaFin] = useState(promocion.hasta);
                    ...
                    {(onClose) => (
                        <>
                            ...
                            <ModalFooter className='flex justify-start'>
                                <p className='text-xs text-gray-500'>Promo valida desde {formatDate(promocion.desde)} hasta el {formatDate(promocion.hasta)} </p>
                            </ModalFooter>
                        </>
                    )}
                </ModalContent>
